...
public class AutorServiceImpl implements AutorService {
    ...
    @Override
    public List<Autor> findAll() {return  autorDAO.findAll();}

    @Override
    public Optional<Autor> findOne(int id) { return autorDAO.findById(id);}

    @Override
    public Autor save(Autor autor) { return autorDAO.save(autor); }
    ...
    public Autor update(int id, Autor autor) {
        ...
        autorExistente.orElse(null).setPais(autor.getCorreo());
