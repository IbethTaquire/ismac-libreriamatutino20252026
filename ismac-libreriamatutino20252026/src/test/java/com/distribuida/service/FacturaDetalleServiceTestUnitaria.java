...
public class FacturaDetalleServiceTestUnitaria {
    ...
    public void setUp() {
        ...
        facturaDetalle.setSubtotal(new BigDecimal("100.00"));
    ...
    public void save() {
        ...
        assertEquals(new BigDecimal("100.00"), detalleGuardado.getSubtotal());
    }
    ...
    public void updateExistente() {
        ...
        detalleActualizado.setSubtotal(new BigDecimal("150.00"));
